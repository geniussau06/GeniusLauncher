...
package com.stepface.mylauncher
...
class HomeActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        apps_list.numColumns = Integer.parseInt(sharedPreferences.getString(if (isPortrait) "grid_columns_portrait" else "grid_columns_landscape", "1"))
